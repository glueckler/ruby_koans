...
class AboutMethods < Neo::Koan
  ...
  def test_sometimes_missing_parentheses_are_ambiguous
    # eval "assert_equal 5, my_global_method 2, 3" # ENABLE CHECK <== original
    eval "assert_equal 5, my_global_method(2, 3)" # ENABLE CHECK <== mine
    #
  ...
  def test_calling_global_methods_with_wrong_number_of_arguments
    ...
    # use functions to change string to regex
