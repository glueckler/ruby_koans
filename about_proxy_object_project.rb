...
class Proxy
  ...
  def method_missing(method_name, *args)
    ...
    # lets try another syntax (using @called instead of self.called)
    @called[method_name] = 0 unless @called.key? method_name
    @called[method_name] += 1
    @object.send(method_name, *args)
  end

  def called? method_name
    @called.key? method_name
  end

  def number_of_times_called method_name
    return 0 unless @called.key? method_name
